...
const ApplyToDrive = () => {
    ...
    return (
        <div className="w-[80vw] lg:w-[90vw] max-w-[1400px] mx-auto rounded-md h-[350px] md:h-[150px] font-serif bg-[#68c96bdd] p-5 my-16 flex flex-col md:flex-row justify-between items-center lg:px-10" >
