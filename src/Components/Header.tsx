    ...
    return (
        <div className="flex flex-col-reverse md:flex-row bg-gray-100">
            ...
            <div className="p-10 lg:p-16 w-full mx-auto md:w-[50%]">
                <h1 className="text-4xl xl:text-5xl font-bold text-center md:text-left md:mt-32 lg:mt-36 xl:mt-32">DOWNLOAD APP, SAVE MONEY, MAKE FRIENDS!</h1>
                ...
                <div className='flex gap-5 justify-center md:justify-start mt-10'>
                    <div className='bg-black text-white lg:text-lg font-bold flex items-center gap-4 px-5 lg:px-8 py-3 rounded'>
